...
model = model_utils.HochuliDeep(INPUT_SHAPE, NUM_CLASSES, nn.ReLU())
...
test_activations(model_original, "results/hochuli_deep/original.csv")
test_activations(model_count, "results/hochuli_deep/count.csv")
test_activations(model_diff, "results/hochuli_deep/diff.csv")
